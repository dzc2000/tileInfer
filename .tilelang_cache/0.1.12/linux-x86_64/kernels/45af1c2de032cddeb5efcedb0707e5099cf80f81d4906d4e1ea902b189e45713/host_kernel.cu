...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)main_Q_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Q shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Q_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_K_cache_shape)[0]) == 199776))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input K_cache shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_K_cache_shape)[0])), (long long)(199776));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_K_cache_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)main_K_cache_strides)[2]);
  }
  if (!((condval_4 == 1))) {
    int32_t condval_5;
    if ((main_K_cache_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)main_K_cache_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input K_cache strides[2] violates packed ABI constraint", (long long)(condval_5), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_6;
  if ((main_K_cache_strides == NULL)) {
    ...
    condval_6 = ((int32_t)((int64_t*)main_K_cache_strides)[1]);
  }
  if (!((condval_6 == 256))) {
    int32_t condval_7;
    if ((main_K_cache_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)main_K_cache_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input K_cache strides[1] violates packed ABI constraint", (long long)(condval_7), (long long)(256));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_8;
  if ((main_K_cache_strides == NULL)) {
    ...
    condval_8 = ((int32_t)((int64_t*)main_K_cache_strides)[0]);
  }
  if (!((condval_8 == 512))) {
    int32_t condval_9;
    if ((main_K_cache_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)main_K_cache_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input K_cache strides[0] violates packed ABI constraint", (long long)(condval_9), (long long)(512));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_V_cache_shape)[0]) == 199776))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input V_cache shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_V_cache_shape)[0])), (long long)(199776));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_V_cache_strides == NULL)) {
    ...
    condval_10 = ((int32_t)((int64_t*)main_V_cache_strides)[2]);
  }
  if (!((condval_10 == 1))) {
    int32_t condval_11;
    if ((main_V_cache_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)main_V_cache_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input V_cache strides[2] violates packed ABI constraint", (long long)(condval_11), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_12;
  if ((main_V_cache_strides == NULL)) {
    ...
    condval_12 = ((int32_t)((int64_t*)main_V_cache_strides)[1]);
  }
  if (!((condval_12 == 256))) {
    int32_t condval_13;
    if ((main_V_cache_strides == NULL)) {
      ...
      condval_13 = ((int32_t)((int64_t*)main_V_cache_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input V_cache strides[1] violates packed ABI constraint", (long long)(condval_13), (long long)(256));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_14;
  if ((main_V_cache_strides == NULL)) {
    ...
    condval_14 = ((int32_t)((int64_t*)main_V_cache_strides)[0]);
  }
  if (!((condval_14 == 512))) {
    int32_t condval_15;
    if ((main_V_cache_strides == NULL)) {
      ...
      condval_15 = ((int32_t)((int64_t*)main_V_cache_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input V_cache strides[0] violates packed ABI constraint", (long long)(condval_15), (long long)(512));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_block_table_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input block_table shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_block_table_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!((((int32_t)((int64_t*)main_block_table_shape)[1]) == 12486))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input block_table shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_block_table_shape)[1])), (long long)(12486));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_16;
  if ((main_block_table_strides == NULL)) {
    ...
    condval_16 = ((int32_t)((int64_t*)main_block_table_strides)[1]);
  }
  if (!((condval_16 == 1))) {
    int32_t condval_17;
    if ((main_block_table_strides == NULL)) {
      ...
      condval_17 = ((int32_t)((int64_t*)main_block_table_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input block_table strides[1] violates packed ABI constraint", (long long)(condval_17), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_seqlen_kv_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input seqlen_kv shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_seqlen_kv_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_Output_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Output shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Output_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_Output_strides == NULL)) {
    ...
    condval_18 = ((int32_t)((int64_t*)main_Output_strides)[2]);
  }
  if (!((condval_18 == 1))) {
    int32_t condval_19;
    if ((main_Output_strides == NULL)) {
      ...
      condval_19 = ((int32_t)((int64_t*)main_Output_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Output strides[2] violates packed ABI constraint", (long long)(condval_19), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_20;
  if ((main_Output_strides == NULL)) {
    ...
    condval_20 = ((int32_t)((int64_t*)main_Output_strides)[1]);
  }
  if (!((condval_20 == 256))) {
    int32_t condval_21;
    if ((main_Output_strides == NULL)) {
      ...
      condval_21 = ((int32_t)((int64_t*)main_Output_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Output strides[1] violates packed ABI constraint", (long long)(condval_21), (long long)(256));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
