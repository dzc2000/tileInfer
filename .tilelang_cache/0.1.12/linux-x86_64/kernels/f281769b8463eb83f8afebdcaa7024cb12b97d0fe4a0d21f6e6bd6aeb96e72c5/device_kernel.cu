  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
  ...
  if (0 < seqlen_kv_b) {
    for (int sub = 0; sub < 4; ++sub) {
      int physical_page = block_table[((((int)blockIdx.x) * 12486) + sub)];
      #pragma unroll
    ...
    for (int sub_1 = 0; sub_1 < 4; ++sub_1) {
      int physical_page_1 = block_table[((((int)blockIdx.x) * 12486) + sub_1)];
      #pragma unroll
  ...
  for (int k = 0; k < (((seqlen_kv_b + 63) >> 6) - 1); ++k) {
    ...
    *(float4*)(acc_s + 0) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
    ...
    for (int sub_2 = 0; sub_2 < 4; ++sub_2) {
      int condval;
      if ((((k * 2) + (sub_2 >> 1)) < 6241)) {
        condval = block_table[((((((int)blockIdx.x) * 12486) + (k * 4)) + sub_2) + 4)];
      } else {
        condval = 0;
      }
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      ...
      scores_max_clear[i_6] = tl::AllReduce<tl::MaxOp, 256, 32, 0>::run(scores_max_clear[i_6], (&(((float*)workspace_2)[0])));
    ...
    for (int sub_3 = 0; sub_3 < 4; ++sub_3) {
      int condval_2;
      if ((((k * 2) + (sub_3 >> 1)) < 6241)) {
        condval_2 = block_table[((((((int)blockIdx.x) * 12486) + (k * 4)) + sub_3) + 4)];
      } else {
        condval_2 = 0;
      }
