...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const bfloat16_t* __restrict__ Alpha, const bfloat16_t* __restrict__ BetaRaw, const bfloat16_t* __restrict__ DtBias, const bfloat16_t* __restrict__ NegAExp, bfloat16_t* __restrict__ NewState, const bfloat16_t* __restrict__ NormW, bfloat16_t* __restrict__ Output, const bfloat16_t* __restrict__ QKV, const bfloat16_t* __restrict__ State, const bfloat16_t* __restrict__ Z) {
  ...
  #pragma unroll
  for (int i = 0; i < 2; ++i) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_read)[((i * 1024) + (((int)threadIdx.x) * 8))])), (&(State[((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i * 1024)) + (((int)threadIdx.x) * 8))])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_read)[(((i_1 * 1024) + (((int)threadIdx.x) * 8)) + 2048)])), (&(State[(((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_1 * 1024)) + (((int)threadIdx.x) * 8)) + 2048)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_2 = 0; i_2 < 2; ++i_2) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_read)[(((i_2 * 1024) + (((int)threadIdx.x) * 8)) + 4096)])), (&(State[(((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_2 * 1024)) + (((int)threadIdx.x) * 8)) + 4096)])));
  }
  tl::cp_async_commit();
  for (int r_start = 0; r_start < 5; ++r_start) {
    ...
    for (int i_4 = 0; i_4 < 2; ++i_4) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)S_read)[((((r_start % 3) * 2048) + (i_4 * 1024)) + (((int)threadIdx.x) * 8))])), (&(State[((((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (r_start * 2048)) + (i_4 * 1024)) + (((int)threadIdx.x) * 8)) + 6144)])));
    }
    tl::cp_async_commit();
    __syncthreads();
    #pragma unroll
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      ...
      *(uint2*)(NewState + (((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (r_start * 2048)) + (i_5 * 512)) + (((int)threadIdx.x) * 4))) = *(uint2*)(NewState_local_cast_2 + 0);
    }
  ...
  for (int i_8 = 0; i_8 < 4; ++i_8) {
    ...
    *(uint2*)(NewState + (((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_8 * 512)) + (((int)threadIdx.x) * 4)) + 10240)) = *(uint2*)(NewState_local_cast_6 + 0);
  }
  dot_k[0] = 0x0p+0f/*0.000000e+00*/;
  __syncthreads();
  ...
  for (int i_11 = 0; i_11 < 4; ++i_11) {
    ...
    *(uint2*)(NewState + (((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_11 * 512)) + (((int)threadIdx.x) * 4)) + 12288)) = *(uint2*)(NewState_local_cast_10 + 0);
  }
  dot_k[0] = 0x0p+0f/*0.000000e+00*/;
  __syncthreads();
  ...
  for (int i_14 = 0; i_14 < 4; ++i_14) {
    ...
    *(uint2*)(NewState + (((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_14 * 512)) + (((int)threadIdx.x) * 4)) + 14336)) = *(uint2*)(NewState_local_cast_14 + 0);
  }
  dot_k[0] = 0x0p+0f/*0.000000e+00*/;
  __syncthreads();
  ...
  for (int i_16 = 0; i_16 < 2; ++i_16) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_read2)[((i_16 * 1024) + (((int)threadIdx.x) * 8))])), (&(NewState[((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_16 * 1024)) + (((int)threadIdx.x) * 8))])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_17 = 0; i_17 < 2; ++i_17) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_read2)[(((i_17 * 1024) + (((int)threadIdx.x) * 8)) + 2048)])), (&(NewState[(((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_17 * 1024)) + (((int)threadIdx.x) * 8)) + 2048)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_18 = 0; i_18 < 2; ++i_18) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_read2)[(((i_18 * 1024) + (((int)threadIdx.x) * 8)) + 4096)])), (&(NewState[(((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_18 * 1024)) + (((int)threadIdx.x) * 8)) + 4096)])));
  }
  tl::cp_async_commit();
  __syncthreads();
  for (int r_start_1 = 0; r_start_1 < 5; ++r_start_1) {
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)S_read2)[((((r_start_1 % 3) * 2048) + (i_20 * 1024)) + (((int)threadIdx.x) * 8))])), (&(NewState[((((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (r_start_1 * 2048)) + (i_20 * 1024)) + (((int)threadIdx.x) * 8)) + 6144)])));
    }
    tl::cp_async_commit();
    __syncthreads();
    #pragma unroll
    for (int i_21 = 0; i_21 < 4; ++i_21) {
      ...
      *(uint2*)(NewState + (((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (r_start_1 * 2048)) + (i_21 * 512)) + (((int)threadIdx.x) * 4))) = *(uint2*)(NewState_local_cast_20 + 0);
    }
  ...
  for (int i_24 = 0; i_24 < 4; ++i_24) {
    ...
    *(uint2*)(NewState + (((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_24 * 512)) + (((int)threadIdx.x) * 4)) + 10240)) = *(uint2*)(NewState_local_cast_26 + 0);
  }
  dot_q[0] = 0x0p+0f/*0.000000e+00*/;
  __syncthreads();
  ...
  for (int i_27 = 0; i_27 < 4; ++i_27) {
    ...
    *(uint2*)(NewState + (((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_27 * 512)) + (((int)threadIdx.x) * 4)) + 12288)) = *(uint2*)(NewState_local_cast_32 + 0);
  }
  dot_q[0] = 0x0p+0f/*0.000000e+00*/;
  __syncthreads();
  ...
  for (int i_30 = 0; i_30 < 4; ++i_30) {
    ...
    *(uint2*)(NewState + (((((((int)blockIdx.y) * 393216) + (((int)blockIdx.x) * 16384)) + (i_30 * 512)) + (((int)threadIdx.x) * 4)) + 14336)) = *(uint2*)(NewState_local_cast_38 + 0);
  }
  dot_q[0] = 0x0p+0f/*0.000000e+00*/;
  __syncthreads();
