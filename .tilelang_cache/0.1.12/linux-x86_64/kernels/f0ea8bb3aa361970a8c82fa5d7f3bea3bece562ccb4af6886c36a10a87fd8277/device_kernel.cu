...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const bfloat16_t* __restrict__ Alpha, const bfloat16_t* __restrict__ BetaRaw, const bfloat16_t* __restrict__ DtBias, const bfloat16_t* __restrict__ NegAExp, bfloat16_t* __restrict__ NewState, const bfloat16_t* __restrict__ NormW, bfloat16_t* __restrict__ Output, const bfloat16_t* __restrict__ QKV, const bfloat16_t* __restrict__ State, const bfloat16_t* __restrict__ Z) {
  ...
  #pragma unroll
  for (int i = 0; i < 2; ++i) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_tile)[((i * 1024) + (((int)threadIdx.x) * 8))])), (&(State[(((((int)blockIdx.x) * 16384) + (i * 1024)) + (((int)threadIdx.x) * 8))])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_tile)[(((i_1 * 1024) + (((int)threadIdx.x) * 8)) + 2048)])), (&(State[((((((int)blockIdx.x) * 16384) + (i_1 * 1024)) + (((int)threadIdx.x) * 8)) + 2048)])));
  }
  tl::cp_async_commit();
  for (int r_start = 0; r_start < 6; ++r_start) {
    ...
    for (int i_3 = 0; i_3 < 2; ++i_3) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)S_tile)[((((r_start & 1) * 2048) + (i_3 * 1024)) + (((int)threadIdx.x) * 8))])), (&(State[(((((((int)blockIdx.x) * 16384) + (r_start * 2048)) + (i_3 * 1024)) + (((int)threadIdx.x) * 8)) + 4096)])));
    }
    tl::cp_async_commit();
  ...
  for (int i_9 = 0; i_9 < 2; ++i_9) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)S_tile2)[((i_9 * 1024) + (((int)threadIdx.x) * 8))])), (&(State[(((((int)blockIdx.x) * 16384) + (i_9 * 1024)) + (((int)threadIdx.x) * 8))])));
  }
  tl::cp_async_commit();
  for (int r_start_1 = 0; r_start_1 < 7; ++r_start_1) {
    ...
    for (int i_10 = 0; i_10 < 2; ++i_10) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)S_tile2)[(((((r_start_1 + 1) & 1) * 2048) + (i_10 * 1024)) + (((int)threadIdx.x) * 8))])), (&(State[(((((((int)blockIdx.x) * 16384) + (r_start_1 * 2048)) + (i_10 * 1024)) + (((int)threadIdx.x) * 8)) + 2048)])));
    }
    tl::cp_async_commit();
    __syncthreads();
    if (((int)threadIdx.x) < 16) {
    ...
    for (int i_11 = 0; i_11 < 4; ++i_11) {
      ...
      *(uint2*)(NewState + ((((((int)blockIdx.x) * 16384) + (r_start_1 * 2048)) + (i_11 * 512)) + (((int)threadIdx.x) * 4))) = *(uint2*)(NewState_local_cast_6 + 0);
    }
  }
  __syncthreads();
  if (((int)threadIdx.x) < 16) {
  ...
  for (int i_12 = 0; i_12 < 4; ++i_12) {
    ...
    *(uint2*)(NewState + ((((((int)blockIdx.x) * 16384) + (i_12 * 512)) + (((int)threadIdx.x) * 4)) + 14336)) = *(uint2*)(NewState_local_cast_10 + 0);
  }
