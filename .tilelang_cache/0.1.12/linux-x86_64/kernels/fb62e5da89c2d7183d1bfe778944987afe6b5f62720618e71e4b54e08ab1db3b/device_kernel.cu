  ...
  if (1 <= seqlen_kv_b) {
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    for (int i_16 = 0; i_16 < 2; ++i_16) {
      ...
      scores_max_clear_1[i_16] = tl::AllReduce<tl::MaxOp, 256, 32, 0>::run(scores_max_clear_1[i_16], (&(((float*)workspace)[0])));
    ...
    for (int i_19 = 0; i_19 < 2; ++i_19) {
      ...
      scores_sum[i_19] = tl::AllReduce<tl::SumOp, 256, 32, 0>::run(scores_sum[i_19], (&(((float*)workspace_2)[0])));
