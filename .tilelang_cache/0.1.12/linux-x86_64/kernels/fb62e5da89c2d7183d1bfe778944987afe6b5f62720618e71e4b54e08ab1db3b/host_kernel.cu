...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)main_K_cache_shape)[0]) == 254752))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input K_cache shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_K_cache_shape)[0])), (long long)(254752));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_V_cache_shape)[0]) == 254752))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input V_cache shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_V_cache_shape)[0])), (long long)(254752));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_block_table_shape)[1]) == 15922))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input block_table shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_block_table_shape)[1])), (long long)(15922));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_16;
