...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)main_x_shape)[0]) == 8704))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input x shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_x_shape)[0])), (long long)(8704));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval;
  ...
  if (!((((int32_t)((int64_t*)main_a_shape)[1]) == 8704))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input a shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_a_shape)[1])), (long long)(8704));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_2;
  ...
  if (!((condval_4 == 8704))) {
    ...
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input a strides[0] violates packed ABI constraint", (long long)(condval_5), (long long)(8704));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
