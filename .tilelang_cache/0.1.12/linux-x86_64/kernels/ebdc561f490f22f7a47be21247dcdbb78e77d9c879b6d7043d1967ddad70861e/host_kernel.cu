...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if ((main_W_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)main_W_strides)[0]);
  }
  if (!((condval_2 == 1))) {
    int32_t condval_3;
    if ((main_W_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)main_W_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input W strides[0] violates packed ABI constraint", (long long)(condval_3), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_Y_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)main_Y_strides)[1]);
  }
  if (!((condval_4 == 1))) {
    int32_t condval_5;
    if ((main_Y_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)main_Y_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y strides[1] violates packed ABI constraint", (long long)(condval_5), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
