...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)main_S_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input S shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_S_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_S_strides == NULL)) {
    ...
    condval_5 = ((int32_t)((int64_t*)main_S_strides)[2]);
  }
  if (!((condval_5 == 1))) {
    int32_t condval_6;
    if ((main_S_strides == NULL)) {
      ...
      condval_6 = ((int32_t)((int64_t*)main_S_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input S strides[2] violates packed ABI constraint", (long long)(condval_6), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_7;
  if ((main_S_strides == NULL)) {
    ...
    condval_7 = ((int32_t)((int64_t*)main_S_strides)[1]);
  }
  if (!((condval_7 == 4))) {
    int32_t condval_8;
    if ((main_S_strides == NULL)) {
      ...
      condval_8 = ((int32_t)((int64_t*)main_S_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input S strides[1] violates packed ABI constraint", (long long)(condval_8), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_W_strides == NULL)) {
    ...
    condval_9 = ((int32_t)((int64_t*)main_W_strides)[1]);
  }
  if (!((condval_9 == 1))) {
    int32_t condval_10;
    if ((main_W_strides == NULL)) {
      ...
      condval_10 = ((int32_t)((int64_t*)main_W_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input W strides[1] violates packed ABI constraint", (long long)(condval_10), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_11;
  if ((main_W_strides == NULL)) {
    ...
    condval_11 = ((int32_t)((int64_t*)main_W_strides)[0]);
  }
  if (!((condval_11 == 4))) {
    int32_t condval_12;
    if ((main_W_strides == NULL)) {
      ...
      condval_12 = ((int32_t)((int64_t*)main_W_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input W strides[0] violates packed ABI constraint", (long long)(condval_12), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  uint8_t condval_13;
  if (!main_Bias_is_null) {
    condval_13 = (((DLTensor*)Bias_handle)[0].dtype.code);
  } else {
    condval_13 = (uint8_t)4;
  }
  uint8_t condval_14;
  if (!main_Bias_is_null) {
    condval_14 = (((DLTensor*)Bias_handle)[0].dtype.bits);
  } else {
    condval_14 = (uint8_t)16;
  }
  uint16_t condval_15;
  if (!main_Bias_is_null) {
    condval_15 = (((DLTensor*)Bias_handle)[0].dtype.lanes);
  } else {
    condval_15 = (uint16_t)1;
  }
  if (!((main_Bias_is_null || (((condval_13 == (uint8_t)4) && (condval_14 == (uint8_t)16)) && (condval_15 == (uint16_t)1))))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input Bias dtype mismatch, expected bfloat16");
    return -1;
  }
  int32_t condval_16;
  if (!main_Bias_is_null) {
    condval_16 = ((int32_t)((int64_t*)main_Bias_shape)[0]);
  } else {
    condval_16 = 0;
  }
  if (!((main_Bias_is_null || (condval_16 == 5120)))) {
  ...
  if ((main_Bias_strides == NULL)) {
    ...
    condval_17 = ((int32_t)((int64_t*)main_Bias_strides)[0]);
  }
  if (!((main_Bias_is_null || (condval_17 == 1)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input Bias strides[0] violates packed ABI constraint");
    return -1;
  }
  uint64_t condval_18;
  if (!main_Bias_is_null) {
    condval_18 = (((DLTensor*)Bias_handle)[0].byte_offset);
  } else {
    condval_18 = (uint64_t)0;
  }
  if (!((main_Bias_is_null || ((uint64_t)0 == condval_18)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input Bias byte_offset violates packed ABI constraint");
    return -1;
  }
  int32_t condval_19;
  if (!main_Bias_is_null) {
    condval_19 = (((DLTensor*)Bias_handle)[0].device.device_id);
  } else {
    condval_19 = 0;
  }
  if (!((main_Bias_is_null || (condval_19 == (((DLTensor*)X_handle)[0].device.device_id))))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input Bias device_id violates packed ABI constraint");
    return -1;
  }
  int32_t condval_20;
  if (!main_Bias_is_null) {
    condval_20 = (((DLTensor*)Bias_handle)[0].device.device_type);
  } else {
    condval_20 = 0;
  }
  if (!((main_Bias_is_null || (condval_20 == 2)))) {
  ...
  if (!((condval_21 == 1))) {
    ...
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y strides[1] violates packed ABI constraint", (long long)(condval_22), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
