...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const bfloat16_t* __restrict__ a, bfloat16_t* __restrict__ o, const bfloat16_t* __restrict__ x) {
  ...
  for (int i_1 = 0; i_1 < 8; ++i_1) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)a_smem)[((i_1 * 1024) + (((int)threadIdx.x) * 8))])), (&(a[((((((int)blockIdx.x) * 327680) + (i_1 * 40960)) + ((((int)threadIdx.x) >> 4) * 5120)) + ((((int)threadIdx.x) & 15) * 8))])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_2 = 0; i_2 < 8; ++i_2) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)a_smem)[(((i_2 * 1024) + (((int)threadIdx.x) * 8)) + 8192)])), (&(a[(((((((int)blockIdx.x) * 327680) + (i_2 * 40960)) + ((((int)threadIdx.x) >> 4) * 5120)) + ((((int)threadIdx.x) & 15) * 8)) + 128)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_3 = 0; i_3 < 8; ++i_3) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)a_smem)[(((i_3 * 1024) + (((int)threadIdx.x) * 8)) + 16384)])), (&(a[(((((((int)blockIdx.x) * 327680) + (i_3 * 40960)) + ((((int)threadIdx.x) >> 4) * 5120)) + ((((int)threadIdx.x) & 15) * 8)) + 256)])));
  }
  tl::cp_async_commit();
  for (int i0_n = 0; i0_n < 37; ++i0_n) {
    tl::cp_async_wait<2>();
    __syncthreads();
    #pragma unroll
    ...
    for (int i_5 = 0; i_5 < 8; ++i_5) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)a_smem)[((((i0_n % 3) * 8192) + (i_5 * 1024)) + (((int)threadIdx.x) * 8))])), (&(a[((((((((int)blockIdx.x) * 327680) + (i_5 * 40960)) + ((((int)threadIdx.x) >> 4) * 5120)) + (i0_n * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 384)])));
    }
    tl::cp_async_commit();
  ...
  for (int i_7 = 0; i_7 < 64; ++i_7) {
    a_frag[i_7] = ((bfloat16_t*)a_smem)[(((i_7 * 128) + ((int)threadIdx.x)) + 8192)];
  }
  x_frag[0] = x[(((int)threadIdx.x) + 4736)];
  #pragma unroll
  ...
  for (int i_9 = 0; i_9 < 64; ++i_9) {
    a_frag[i_9] = ((bfloat16_t*)a_smem)[(((i_9 * 128) + ((int)threadIdx.x)) + 16384)];
  }
  x_frag[0] = x[(((int)threadIdx.x) + 4864)];
  #pragma unroll
  ...
  for (int i_11 = 0; i_11 < 64; ++i_11) {
    a_frag[i_11] = ((bfloat16_t*)a_smem)[((i_11 * 128) + ((int)threadIdx.x))];
  }
  x_frag[0] = x[(((int)threadIdx.x) + 4992)];
  #pragma unroll
