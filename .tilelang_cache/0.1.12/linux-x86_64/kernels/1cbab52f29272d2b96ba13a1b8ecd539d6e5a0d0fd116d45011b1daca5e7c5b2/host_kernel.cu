...
int32_t __tvm_ffi_kernel(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)kernel_QKV_shape)[0]) == 16))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input QKV shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_QKV_shape)[0])), (long long)(16));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_QKV_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)kernel_QKV_strides)[0]);
  }
  if (!((condval_2 == 5120))) {
    int32_t condval_3;
    if ((kernel_QKV_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)kernel_QKV_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input QKV strides[0] violates packed ABI constraint", (long long)(condval_3), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_Alpha_shape)[0]) == 16))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Alpha shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_Alpha_shape)[0])), (long long)(16));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_Alpha_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)kernel_Alpha_strides)[1]);
  }
  if (!((condval_4 == 1))) {
    int32_t condval_5;
    if ((kernel_Alpha_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)kernel_Alpha_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Alpha strides[1] violates packed ABI constraint", (long long)(condval_5), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_6;
  if ((kernel_Alpha_strides == NULL)) {
    ...
    condval_6 = ((int32_t)((int64_t*)kernel_Alpha_strides)[0]);
  }
  if (!((condval_6 == 24))) {
    int32_t condval_7;
    if ((kernel_Alpha_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)kernel_Alpha_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Alpha strides[0] violates packed ABI constraint", (long long)(condval_7), (long long)(24));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_BetaRaw_shape)[0]) == 16))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input BetaRaw shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_BetaRaw_shape)[0])), (long long)(16));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_BetaRaw_strides == NULL)) {
    ...
    condval_8 = ((int32_t)((int64_t*)kernel_BetaRaw_strides)[1]);
  }
  if (!((condval_8 == 1))) {
    int32_t condval_9;
    if ((kernel_BetaRaw_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)kernel_BetaRaw_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input BetaRaw strides[1] violates packed ABI constraint", (long long)(condval_9), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_10;
  if ((kernel_BetaRaw_strides == NULL)) {
    ...
    condval_10 = ((int32_t)((int64_t*)kernel_BetaRaw_strides)[0]);
  }
  if (!((condval_10 == 24))) {
    int32_t condval_11;
    if ((kernel_BetaRaw_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)kernel_BetaRaw_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input BetaRaw strides[0] violates packed ABI constraint", (long long)(condval_11), (long long)(24));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_NegAExp_strides == NULL)) {
    ...
    condval_12 = ((int32_t)((int64_t*)kernel_NegAExp_strides)[0]);
  }
  if (!((condval_12 == 1))) {
    int32_t condval_13;
    if ((kernel_NegAExp_strides == NULL)) {
      ...
      condval_13 = ((int32_t)((int64_t*)kernel_NegAExp_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input NegAExp strides[0] violates packed ABI constraint", (long long)(condval_13), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_DtBias_strides == NULL)) {
    ...
    condval_14 = ((int32_t)((int64_t*)kernel_DtBias_strides)[0]);
  }
  if (!((condval_14 == 1))) {
    int32_t condval_15;
    if ((kernel_DtBias_strides == NULL)) {
      ...
      condval_15 = ((int32_t)((int64_t*)kernel_DtBias_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input DtBias strides[0] violates packed ABI constraint", (long long)(condval_15), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_State_shape)[0]) == 16))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input State shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_State_shape)[0])), (long long)(16));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_State_strides == NULL)) {
    ...
    condval_16 = ((int32_t)((int64_t*)kernel_State_strides)[3]);
  }
  if (!((condval_16 == 1))) {
    int32_t condval_17;
    if ((kernel_State_strides == NULL)) {
      ...
      condval_17 = ((int32_t)((int64_t*)kernel_State_strides)[3]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input State strides[3] violates packed ABI constraint", (long long)(condval_17), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_18;
  if ((kernel_State_strides == NULL)) {
    ...
    condval_18 = ((int32_t)((int64_t*)kernel_State_strides)[2]);
  }
  if (!((condval_18 == 128))) {
    int32_t condval_19;
    if ((kernel_State_strides == NULL)) {
      ...
      condval_19 = ((int32_t)((int64_t*)kernel_State_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input State strides[2] violates packed ABI constraint", (long long)(condval_19), (long long)(128));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_20;
  if ((kernel_State_strides == NULL)) {
    ...
    condval_20 = ((int32_t)((int64_t*)kernel_State_strides)[1]);
  }
  if (!((condval_20 == 16384))) {
    int32_t condval_21;
    if ((kernel_State_strides == NULL)) {
      ...
      condval_21 = ((int32_t)((int64_t*)kernel_State_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input State strides[1] violates packed ABI constraint", (long long)(condval_21), (long long)(16384));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_22;
  if ((kernel_State_strides == NULL)) {
    ...
    condval_22 = ((int32_t)((int64_t*)kernel_State_strides)[0]);
  }
  if (!((condval_22 == 393216))) {
    int32_t condval_23;
    if ((kernel_State_strides == NULL)) {
      condval_23 = 1;
    } else {
      condval_23 = ((int32_t)((int64_t*)kernel_State_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input State strides[0] violates packed ABI constraint", (long long)(condval_23), (long long)(393216));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_NormW_strides == NULL)) {
    ...
    condval_24 = ((int32_t)((int64_t*)kernel_NormW_strides)[0]);
  }
  if (!((condval_24 == 1))) {
    int32_t condval_25;
    if ((kernel_NormW_strides == NULL)) {
      ...
      condval_25 = ((int32_t)((int64_t*)kernel_NormW_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input NormW strides[0] violates packed ABI constraint", (long long)(condval_25), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_Z_shape)[0]) == 16))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Z shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_Z_shape)[0])), (long long)(16));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_Z_strides == NULL)) {
    ...
    condval_26 = ((int32_t)((int64_t*)kernel_Z_strides)[2]);
  }
  if (!((condval_26 == 1))) {
    int32_t condval_27;
    if ((kernel_Z_strides == NULL)) {
      ...
      condval_27 = ((int32_t)((int64_t*)kernel_Z_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Z strides[2] violates packed ABI constraint", (long long)(condval_27), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_28;
  if ((kernel_Z_strides == NULL)) {
    ...
    condval_28 = ((int32_t)((int64_t*)kernel_Z_strides)[1]);
  }
  if (!((condval_28 == 128))) {
    int32_t condval_29;
    if ((kernel_Z_strides == NULL)) {
      ...
      condval_29 = ((int32_t)((int64_t*)kernel_Z_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Z strides[1] violates packed ABI constraint", (long long)(condval_29), (long long)(128));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_30;
  if ((kernel_Z_strides == NULL)) {
    ...
    condval_30 = ((int32_t)((int64_t*)kernel_Z_strides)[0]);
  }
  if (!((condval_30 == 3072))) {
    int32_t condval_31;
    if ((kernel_Z_strides == NULL)) {
      ...
      condval_31 = ((int32_t)((int64_t*)kernel_Z_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Z strides[0] violates packed ABI constraint", (long long)(condval_31), (long long)(3072));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_NewState_shape)[0]) == 16))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input NewState shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_NewState_shape)[0])), (long long)(16));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_NewState_strides == NULL)) {
    ...
    condval_32 = ((int32_t)((int64_t*)kernel_NewState_strides)[3]);
  }
  if (!((condval_32 == 1))) {
    int32_t condval_33;
    if ((kernel_NewState_strides == NULL)) {
      ...
      condval_33 = ((int32_t)((int64_t*)kernel_NewState_strides)[3]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input NewState strides[3] violates packed ABI constraint", (long long)(condval_33), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_34;
  if ((kernel_NewState_strides == NULL)) {
    ...
    condval_34 = ((int32_t)((int64_t*)kernel_NewState_strides)[2]);
  }
  if (!((condval_34 == 128))) {
    int32_t condval_35;
    if ((kernel_NewState_strides == NULL)) {
      ...
      condval_35 = ((int32_t)((int64_t*)kernel_NewState_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input NewState strides[2] violates packed ABI constraint", (long long)(condval_35), (long long)(128));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_36;
  if ((kernel_NewState_strides == NULL)) {
    ...
    condval_36 = ((int32_t)((int64_t*)kernel_NewState_strides)[1]);
  }
  if (!((condval_36 == 16384))) {
    int32_t condval_37;
    if ((kernel_NewState_strides == NULL)) {
      ...
      condval_37 = ((int32_t)((int64_t*)kernel_NewState_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input NewState strides[1] violates packed ABI constraint", (long long)(condval_37), (long long)(16384));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_38;
  if ((kernel_NewState_strides == NULL)) {
    ...
    condval_38 = ((int32_t)((int64_t*)kernel_NewState_strides)[0]);
  }
  if (!((condval_38 == 393216))) {
    int32_t condval_39;
    if ((kernel_NewState_strides == NULL)) {
      condval_39 = 1;
    } else {
      condval_39 = ((int32_t)((int64_t*)kernel_NewState_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input NewState strides[0] violates packed ABI constraint", (long long)(condval_39), (long long)(393216));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_Output_shape)[0]) == 16))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Output shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_Output_shape)[0])), (long long)(16));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((kernel_Output_strides == NULL)) {
    ...
    condval_40 = ((int32_t)((int64_t*)kernel_Output_strides)[2]);
  }
  if (!((condval_40 == 1))) {
    int32_t condval_41;
    if ((kernel_Output_strides == NULL)) {
      ...
      condval_41 = ((int32_t)((int64_t*)kernel_Output_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Output strides[2] violates packed ABI constraint", (long long)(condval_41), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_42;
  if ((kernel_Output_strides == NULL)) {
    ...
    condval_42 = ((int32_t)((int64_t*)kernel_Output_strides)[1]);
  }
  if (!((condval_42 == 128))) {
    int32_t condval_43;
    if ((kernel_Output_strides == NULL)) {
      ...
      condval_43 = ((int32_t)((int64_t*)kernel_Output_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Output strides[1] violates packed ABI constraint", (long long)(condval_43), (long long)(128));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_44;
  if ((kernel_Output_strides == NULL)) {
    ...
    condval_44 = ((int32_t)((int64_t*)kernel_Output_strides)[0]);
  }
  if (!((condval_44 == 3072))) {
    int32_t condval_45;
    if ((kernel_Output_strides == NULL)) {
      ...
      condval_45 = ((int32_t)((int64_t*)kernel_Output_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Output strides[0] violates packed ABI constraint", (long long)(condval_45), (long long)(3072));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  (((TVMFFIAny*)stack_ffi_any)[11].v_int64) = ((int64_t)16);
  ...
  (((TVMFFIAny*)stack_ffi_any)[15].v_int64) = ((int64_t)18768);
