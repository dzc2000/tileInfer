...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)main_Key_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Key shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Key_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_Value_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Value shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Value_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_Value_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)main_Value_strides)[1]);
  }
  if (!((condval_2 == 1))) {
    int32_t condval_3;
    if ((main_Value_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)main_Value_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Value strides[1] violates packed ABI constraint", (long long)(condval_3), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_Slot_Mapping_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Slot_Mapping shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Slot_Mapping_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_K_Cache_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)main_K_Cache_strides)[1]);
  }
  if (!((condval_4 == 1))) {
    int32_t condval_5;
    if ((main_K_Cache_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)main_K_Cache_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input K_Cache strides[1] violates packed ABI constraint", (long long)(condval_5), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_6;
  if ((main_K_Cache_strides == NULL)) {
    ...
    condval_6 = ((int32_t)((int64_t*)main_K_Cache_strides)[0]);
  }
  if (!((condval_6 == 512))) {
    int32_t condval_7;
    if ((main_K_Cache_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)main_K_Cache_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input K_Cache strides[0] violates packed ABI constraint", (long long)(condval_7), (long long)(512));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_V_Cache_strides == NULL)) {
    ...
    condval_8 = ((int32_t)((int64_t*)main_V_Cache_strides)[1]);
  }
  if (!((condval_8 == 1))) {
    int32_t condval_9;
    if ((main_V_Cache_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)main_V_Cache_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input V_Cache strides[1] violates packed ABI constraint", (long long)(condval_9), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_10;
  if ((main_V_Cache_strides == NULL)) {
    ...
    condval_10 = ((int32_t)((int64_t*)main_V_Cache_strides)[0]);
  }
  if (!((condval_10 == 512))) {
    int32_t condval_11;
    if ((main_V_Cache_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)main_V_Cache_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input V_Cache strides[0] violates packed ABI constraint", (long long)(condval_11), (long long)(512));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
