...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  int32_t partial_max_handle_type_index = (((TVMFFIAny*)args)[2].type_index);
  ...
  int32_t partial_idx_handle_type_index = (((TVMFFIAny*)args)[3].type_index);
  ...
  void* partial_max_handle = ((partial_max_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[2].v_ptr) + 24)) : (((TVMFFIAny*)args)[2].v_ptr));
  void* partial_idx_handle = ((partial_idx_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[3].v_ptr) + 24)) : (((TVMFFIAny*)args)[3].v_ptr));
  ...
  if (!((((int32_t)((int64_t*)main_A_shape)[0]) == 1))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input A shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_A_shape)[0])), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_B_shape)[0]) == 124160))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input B shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_B_shape)[0])), (long long)(124160));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!((((int32_t)((int64_t*)main_B_shape)[1]) == 5120))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input B shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_B_shape)[1])), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_2;
  if ((main_B_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)main_B_strides)[1]);
  }
  if (!((condval_2 == 1))) {
    int32_t condval_3;
    if ((main_B_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)main_B_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input B strides[1] violates packed ABI constraint", (long long)(condval_3), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_4;
  if ((main_B_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)main_B_strides)[0]);
  }
  if (!((condval_4 == 5120))) {
    int32_t condval_5;
    if ((main_B_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)main_B_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input B strides[0] violates packed ABI constraint", (long long)(condval_5), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_partial_max_strides == NULL)) {
    ...
    condval_6 = ((int32_t)((int64_t*)main_partial_max_strides)[0]);
  }
  if (!((condval_6 == 1))) {
    int32_t condval_7;
    if ((main_partial_max_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)main_partial_max_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input partial_max strides[0] violates packed ABI constraint", (long long)(condval_7), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!(((((DLTensor*)partial_max_handle)[0].device.device_id) == (((DLTensor*)A_handle)[0].device.device_id)))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input partial_max device_id violates packed ABI constraint", (long long)((((DLTensor*)partial_max_handle)[0].device.device_id)), (long long)((((DLTensor*)A_handle)[0].device.device_id)));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_partial_idx_strides == NULL)) {
    ...
    condval_8 = ((int32_t)((int64_t*)main_partial_idx_strides)[0]);
  }
  if (!((condval_8 == 1))) {
    int32_t condval_9;
    if ((main_partial_idx_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)main_partial_idx_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input partial_idx strides[0] violates packed ABI constraint", (long long)(condval_9), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!(((((DLTensor*)partial_idx_handle)[0].device.device_id) == (((DLTensor*)A_handle)[0].device.device_id)))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input partial_idx device_id violates packed ABI constraint", (long long)((((DLTensor*)partial_idx_handle)[0].device.device_id)), (long long)((((DLTensor*)A_handle)[0].device.device_id)));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)970);
  ...
  (((TVMFFIAny*)stack_ffi_any)[9].v_int64) = ((int64_t)73728);
