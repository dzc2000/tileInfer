...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)main_X_shape)[1]) == 5))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_X_shape)[1])), (long long)(5));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_Y_shape)[1]) == 5))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Y_shape)[1])), (long long)(5));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)5);
