...
int32_t __tvm_ffi_kernel(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)kernel_QKV_shape)[0]) == 4))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input QKV shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_QKV_shape)[0])), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_Alpha_shape)[0]) == 4))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Alpha shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_Alpha_shape)[0])), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_BetaRaw_shape)[0]) == 4))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input BetaRaw shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_BetaRaw_shape)[0])), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_State_shape)[0]) == 4))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input State shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_State_shape)[0])), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_Z_shape)[0]) == 4))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Z shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_Z_shape)[0])), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_NewState_shape)[0]) == 4))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input NewState shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_NewState_shape)[0])), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)kernel_Output_shape)[0]) == 4))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel kernel input Output shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)kernel_Output_shape)[0])), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
