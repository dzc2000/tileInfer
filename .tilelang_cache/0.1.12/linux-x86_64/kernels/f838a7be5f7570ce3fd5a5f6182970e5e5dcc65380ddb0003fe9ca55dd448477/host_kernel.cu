...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((((int32_t)((int64_t*)main_Key_shape)[0]) == 39))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Key shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Key_shape)[0])), (long long)(39));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_Value_shape)[0]) == 39))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Value shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Value_shape)[0])), (long long)(39));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_Slot_Mapping_shape)[0]) == 39))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Slot_Mapping shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Slot_Mapping_shape)[0])), (long long)(39));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_8;
