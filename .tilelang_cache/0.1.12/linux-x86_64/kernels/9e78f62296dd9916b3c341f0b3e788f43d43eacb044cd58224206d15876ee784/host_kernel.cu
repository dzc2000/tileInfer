...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  int32_t R_handle_type_index = (((TVMFFIAny*)args)[0].type_index);
  if (!(((((R_handle_type_index == 0) || (R_handle_type_index == 4)) || (R_handle_type_index == 7)) || (64 <= R_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input R expected pointer or tensor handle");
    return -1;
  }
  int32_t X_handle_type_index = (((TVMFFIAny*)args)[1].type_index);
  ...
  int32_t NR_handle_type_index = (((TVMFFIAny*)args)[3].type_index);
  if (!(((((NR_handle_type_index == 0) || (NR_handle_type_index == 4)) || (NR_handle_type_index == 7)) || (64 <= NR_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input NR expected pointer or tensor handle");
    return -1;
  }
  ...
  void* R_handle = ((R_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[0].v_ptr) + 24)) : (((TVMFFIAny*)args)[0].v_ptr));
  void* X_handle = ((X_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[1].v_ptr) + 24)) : (((TVMFFIAny*)args)[1].v_ptr));
  void* W_handle = ((W_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[2].v_ptr) + 24)) : (((TVMFFIAny*)args)[2].v_ptr));
  void* NR_handle = ((NR_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[3].v_ptr) + 24)) : (((TVMFFIAny*)args)[3].v_ptr));
  void* Y_handle = ((Y_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[4].v_ptr) + 24)) : (((TVMFFIAny*)args)[4].v_ptr));
  bool main_R_is_null = (R_handle == NULL);
  if (!(!main_R_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "main.R is expected to have non-NULL pointer");
    return -1;
  }
  ...
  bool main_NR_is_null = (NR_handle == NULL);
  if (!(!main_NR_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "main.NR is expected to have non-NULL pointer");
    return -1;
  }
  ...
  void* main_R_shape = (((DLTensor*)R_handle)[0].shape);
  void* main_X_shape = (((DLTensor*)X_handle)[0].shape);
  void* main_W_shape = (((DLTensor*)W_handle)[0].shape);
  void* main_NR_shape = (((DLTensor*)NR_handle)[0].shape);
  void* main_Y_shape = (((DLTensor*)Y_handle)[0].shape);
  if (!(((((DLTensor*)R_handle)[0].ndim) == 2))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input R ndim mismatch, expected 2", (long long)((((DLTensor*)R_handle)[0].ndim)), (long long)(2));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  void* main_R_strides = (((DLTensor*)R_handle)[0].strides);
  int32_t dev_id = (((DLTensor*)R_handle)[0].device.device_id);
  void* R = (((DLTensor*)R_handle)[0].data);
  ...
  if (!(((((DLTensor*)NR_handle)[0].ndim) == 2))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input NR ndim mismatch, expected 2", (long long)((((DLTensor*)NR_handle)[0].ndim)), (long long)(2));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  void* main_NR_strides = (((DLTensor*)NR_handle)[0].strides);
  void* NR = (((DLTensor*)NR_handle)[0].data);
  ...
  if (!(((((((DLTensor*)R_handle)[0].dtype.code) == (uint8_t)4) && ((((DLTensor*)R_handle)[0].dtype.bits) == (uint8_t)16)) && ((((DLTensor*)R_handle)[0].dtype.lanes) == (uint16_t)1)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input R dtype mismatch, expected bfloat16");
    return -1;
  }
  if (!((((int32_t)((int64_t*)main_R_shape)[0]) == 205))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input R shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_R_shape)[0])), (long long)(205));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!((((int32_t)((int64_t*)main_R_shape)[1]) == 5120))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input R shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_R_shape)[1])), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval;
  if ((main_R_strides == NULL)) {
    condval = 1;
  } else {
    condval = ((int32_t)((int64_t*)main_R_strides)[1]);
  }
  if (!((condval == 1))) {
    int32_t condval_1;
    if ((main_R_strides == NULL)) {
      ...
      condval_1 = ((int32_t)((int64_t*)main_R_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input R strides[1] violates packed ABI constraint", (long long)(condval_1), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_2;
  if ((main_R_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)main_R_strides)[0]);
  }
  if (!((condval_2 == 5120))) {
    int32_t condval_3;
    if ((main_R_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)main_R_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input R strides[0] violates packed ABI constraint", (long long)(condval_3), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(((uint64_t)0 == (((DLTensor*)R_handle)[0].byte_offset)))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input R byte_offset violates packed ABI constraint", (long long)((uint64_t)0), (long long)((((DLTensor*)R_handle)[0].byte_offset)));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(((((DLTensor*)R_handle)[0].device.device_type) == 2))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input R device_type mismatch, expected cuda", (long long)((((DLTensor*)R_handle)[0].device.device_type)), (long long)(2));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(!(R == NULL))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input R data pointer is NULL");
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_X_shape)[0]) == 205))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_X_shape)[0])), (long long)(205));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((condval_4 == 1))) {
    ...
    if ((main_X_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)main_X_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X strides[1] violates packed ABI constraint", (long long)(condval_5), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_6;
  ...
  if (!((condval_6 == 5120))) {
    ...
    if ((main_X_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)main_X_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X strides[0] violates packed ABI constraint", (long long)(condval_7), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!(((((DLTensor*)X_handle)[0].device.device_id) == (((DLTensor*)R_handle)[0].device.device_id)))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X device_id violates packed ABI constraint", (long long)((((DLTensor*)X_handle)[0].device.device_id)), (long long)((((DLTensor*)R_handle)[0].device.device_id)));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_W_strides == NULL)) {
    ...
    condval_8 = ((int32_t)((int64_t*)main_W_strides)[0]);
  }
  if (!((condval_8 == 1))) {
    int32_t condval_9;
    if ((main_W_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)main_W_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input W strides[0] violates packed ABI constraint", (long long)(condval_9), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!(((((DLTensor*)W_handle)[0].device.device_id) == (((DLTensor*)R_handle)[0].device.device_id)))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input W device_id violates packed ABI constraint", (long long)((((DLTensor*)W_handle)[0].device.device_id)), (long long)((((DLTensor*)R_handle)[0].device.device_id)));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!(((((((DLTensor*)NR_handle)[0].dtype.code) == (uint8_t)4) && ((((DLTensor*)NR_handle)[0].dtype.bits) == (uint8_t)16)) && ((((DLTensor*)NR_handle)[0].dtype.lanes) == (uint16_t)1)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input NR dtype mismatch, expected bfloat16");
    return -1;
  }
  if (!((((int32_t)((int64_t*)main_NR_shape)[0]) == 205))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input NR shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_NR_shape)[0])), (long long)(205));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!((((int32_t)((int64_t*)main_NR_shape)[1]) == 5120))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input NR shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_NR_shape)[1])), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_10;
  if ((main_NR_strides == NULL)) {
    condval_10 = 1;
  } else {
    condval_10 = ((int32_t)((int64_t*)main_NR_strides)[1]);
  }
  if (!((condval_10 == 1))) {
    int32_t condval_11;
    if ((main_NR_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)main_NR_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input NR strides[1] violates packed ABI constraint", (long long)(condval_11), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_12;
  if ((main_NR_strides == NULL)) {
    ...
    condval_12 = ((int32_t)((int64_t*)main_NR_strides)[0]);
  }
  if (!((condval_12 == 5120))) {
    int32_t condval_13;
    if ((main_NR_strides == NULL)) {
      ...
      condval_13 = ((int32_t)((int64_t*)main_NR_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input NR strides[0] violates packed ABI constraint", (long long)(condval_13), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(((uint64_t)0 == (((DLTensor*)NR_handle)[0].byte_offset)))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input NR byte_offset violates packed ABI constraint", (long long)((uint64_t)0), (long long)((((DLTensor*)NR_handle)[0].byte_offset)));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(((((DLTensor*)NR_handle)[0].device.device_id) == (((DLTensor*)R_handle)[0].device.device_id)))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input NR device_id violates packed ABI constraint", (long long)((((DLTensor*)NR_handle)[0].device.device_id)), (long long)((((DLTensor*)R_handle)[0].device.device_id)));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(((((DLTensor*)NR_handle)[0].device.device_type) == 2))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input NR device_type mismatch, expected cuda", (long long)((((DLTensor*)NR_handle)[0].device.device_type)), (long long)(2));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(!(NR == NULL))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input NR data pointer is NULL");
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_Y_shape)[0]) == 205))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y shape[0] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Y_shape)[0])), (long long)(205));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_Y_strides == NULL)) {
    ...
    condval_14 = ((int32_t)((int64_t*)main_Y_strides)[1]);
  }
  if (!((condval_14 == 1))) {
    int32_t condval_15;
    if ((main_Y_strides == NULL)) {
      ...
      condval_15 = ((int32_t)((int64_t*)main_Y_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y strides[1] violates packed ABI constraint", (long long)(condval_15), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_16;
  if ((main_Y_strides == NULL)) {
    ...
    condval_16 = ((int32_t)((int64_t*)main_Y_strides)[0]);
  }
  if (!((condval_16 == 5120))) {
    int32_t condval_17;
    if ((main_Y_strides == NULL)) {
      ...
      condval_17 = ((int32_t)((int64_t*)main_Y_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y strides[0] violates packed ABI constraint", (long long)(condval_17), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!(((((DLTensor*)Y_handle)[0].device.device_id) == (((DLTensor*)R_handle)[0].device.device_id)))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y device_id violates packed ABI constraint", (long long)((((DLTensor*)Y_handle)[0].device.device_id)), (long long)((((DLTensor*)R_handle)[0].device.device_id)));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = NR;
  if (R == NULL) {
  ...
  (((TVMFFIAny*)stack_ffi_any)[1].v_ptr) = R;
  if (W == NULL) {
    (((TVMFFIAny*)stack_ffi_any)[2].type_index) = 0;
  } else {
  ...
  (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = ((int64_t)205);
  ...
  (((TVMFFIAny*)stack_ffi_any)[9].v_int64) = ((int64_t)10240);
