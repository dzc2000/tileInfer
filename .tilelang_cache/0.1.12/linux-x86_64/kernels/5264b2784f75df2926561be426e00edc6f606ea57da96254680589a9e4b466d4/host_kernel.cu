...
int32_t __tvm_ffi_main(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  int32_t Y_handle_type_index = (((TVMFFIAny*)args)[3].type_index);
  ...
  void* Y_handle = ((Y_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[3].v_ptr) + 24)) : (((TVMFFIAny*)args)[3].v_ptr));
  ...
  if (!(((((DLTensor*)X_handle)[0].ndim) == 3))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X ndim mismatch, expected 3", (long long)((((DLTensor*)X_handle)[0].ndim)), (long long)(3));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  void* Bias = condval_2;
  if (!(((((DLTensor*)Y_handle)[0].ndim) == 3))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y ndim mismatch, expected 3", (long long)((((DLTensor*)Y_handle)[0].ndim)), (long long)(3));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if (!((((int32_t)((int64_t*)main_X_shape)[1]) == 208))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_X_shape)[1])), (long long)(208));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!((((int32_t)((int64_t*)main_X_shape)[2]) == 5120))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X shape[2] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_X_shape)[2])), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_3;
  if ((main_X_strides == NULL)) {
    ...
    condval_3 = ((int32_t)((int64_t*)main_X_strides)[2]);
  }
  if (!((condval_3 == 1))) {
    int32_t condval_4;
    if ((main_X_strides == NULL)) {
      ...
      condval_4 = ((int32_t)((int64_t*)main_X_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X strides[2] violates packed ABI constraint", (long long)(condval_4), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_5;
  ...
  if (!((condval_5 == 5120))) {
    ...
    if ((main_X_strides == NULL)) {
      ...
      condval_6 = ((int32_t)((int64_t*)main_X_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input X strides[1] violates packed ABI constraint", (long long)(condval_6), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  if ((main_W_strides == NULL)) {
    ...
    condval_7 = ((int32_t)((int64_t*)main_W_strides)[1]);
  }
  if (!((condval_7 == 1))) {
    int32_t condval_8;
    if ((main_W_strides == NULL)) {
      ...
      condval_8 = ((int32_t)((int64_t*)main_W_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input W strides[1] violates packed ABI constraint", (long long)(condval_8), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_9;
  ...
  if (!((condval_9 == 4))) {
    ...
    if ((main_W_strides == NULL)) {
      ...
      condval_10 = ((int32_t)((int64_t*)main_W_strides)[0]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input W strides[0] violates packed ABI constraint", (long long)(condval_10), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  uint8_t condval_11;
  if (!main_Bias_is_null) {
    condval_11 = (((DLTensor*)Bias_handle)[0].dtype.code);
  } else {
    condval_11 = (uint8_t)4;
  }
  uint8_t condval_12;
  if (!main_Bias_is_null) {
    condval_12 = (((DLTensor*)Bias_handle)[0].dtype.bits);
  } else {
    condval_12 = (uint8_t)16;
  }
  uint16_t condval_13;
  if (!main_Bias_is_null) {
    condval_13 = (((DLTensor*)Bias_handle)[0].dtype.lanes);
  } else {
    condval_13 = (uint16_t)1;
  }
  if (!((main_Bias_is_null || (((condval_11 == (uint8_t)4) && (condval_12 == (uint8_t)16)) && (condval_13 == (uint16_t)1))))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input Bias dtype mismatch, expected bfloat16");
    return -1;
  }
  int32_t condval_14;
  if (!main_Bias_is_null) {
    condval_14 = ((int32_t)((int64_t*)main_Bias_shape)[0]);
  } else {
    condval_14 = 0;
  }
  if (!((main_Bias_is_null || (condval_14 == 5120)))) {
  ...
  if ((main_Bias_strides == NULL)) {
    ...
    condval_15 = ((int32_t)((int64_t*)main_Bias_strides)[0]);
  }
  if (!((main_Bias_is_null || (condval_15 == 1)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input Bias strides[0] violates packed ABI constraint");
    return -1;
  }
  uint64_t condval_16;
  if (!main_Bias_is_null) {
    condval_16 = (((DLTensor*)Bias_handle)[0].byte_offset);
  } else {
    condval_16 = (uint64_t)0;
  }
  if (!((main_Bias_is_null || ((uint64_t)0 == condval_16)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input Bias byte_offset violates packed ABI constraint");
    return -1;
  }
  int32_t condval_17;
  if (!main_Bias_is_null) {
    condval_17 = (((DLTensor*)Bias_handle)[0].device.device_id);
  } else {
    condval_17 = 0;
  }
  if (!((main_Bias_is_null || (condval_17 == (((DLTensor*)X_handle)[0].device.device_id))))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel main input Bias device_id violates packed ABI constraint");
    return -1;
  }
  int32_t condval_18;
  if (!main_Bias_is_null) {
    condval_18 = (((DLTensor*)Bias_handle)[0].device.device_type);
  } else {
    condval_18 = 0;
  }
  if (!((main_Bias_is_null || (condval_18 == 2)))) {
  ...
  if (!((((int32_t)((int64_t*)main_Y_shape)[1]) == 208))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y shape[1] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Y_shape)[1])), (long long)(208));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!((((int32_t)((int64_t*)main_Y_shape)[2]) == 5120))) {
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y shape[2] violates packed ABI constraint", (long long)(((int32_t)((int64_t*)main_Y_shape)[2])), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_19;
  if ((main_Y_strides == NULL)) {
    ...
    condval_19 = ((int32_t)((int64_t*)main_Y_strides)[2]);
  }
  if (!((condval_19 == 1))) {
    int32_t condval_20;
    if ((main_Y_strides == NULL)) {
      ...
      condval_20 = ((int32_t)((int64_t*)main_Y_strides)[2]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y strides[2] violates packed ABI constraint", (long long)(condval_20), (long long)(1));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  int32_t condval_21;
  if ((main_Y_strides == NULL)) {
    ...
    condval_21 = ((int32_t)((int64_t*)main_Y_strides)[1]);
  }
  if (!((condval_21 == 5120))) {
    int32_t condval_22;
    if ((main_Y_strides == NULL)) {
      ...
      condval_22 = ((int32_t)((int64_t*)main_Y_strides)[1]);
    }
    char __tvm_assert_msg_buf[512];
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel main input Y strides[1] violates packed ABI constraint", (long long)(condval_22), (long long)(5120));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  ...
  (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = W;
  if (X == NULL) {
  ...
  (((TVMFFIAny*)stack_ffi_any)[2].v_ptr) = Y;
  ...
  (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)208);
